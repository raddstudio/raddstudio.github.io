...
const Photography = () => {
  ...
  return <Page section="photography">
    <div className="bg-dark text-secondary px-4 py-5 text-center">
      <div className="py-5">
        <h1 className="display-5 fw-bold text-white">Photography</h1>
        <div className="col-lg-6 mx-auto">
          <p className="fs-5 mb-4">We have always have had a fancy for mechanical things, cameras are a guilty pleasure that we dont endulge enough, shurely. </p>
          <p>Here are some of our favourite snaps, highlighting some of our favourite places.</p>
        </div>
        <div className="row">
