...
var managementEvents = [{
  title: 'Monthly team meeting for Studio React Project',
...
var echartSetOption = function echartSetOption(chart, userOptions, getDefaultOptions) {
  ...
  themeController.addEventListener('clickControl', function (_ref5) {
...
var sessionByCountryMapInit = function sessionByCountryMapInit() {
  ...
  if ($sessionByCountryMap) {
    ...
    echartSetOption(chart, userOptions, getDefaultOptions);
    (_document$querySelect4 = document.querySelector('.session-by-country-map-reset')) === null || _document$querySelect4 === void 0 ? void 0 : _document$querySelect4.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'restore'
      });
    });
...
var topProductsInit = function topProductsInit() {
  ...
  if ($echartBarTopProducts) {
    var data = [['product', '2019', '2018'], ['Boots4', 43, 85], ['Reign Pro', 83, 73], ['Slick', 86, 62], ['Studio', 72, 53], ['Sparrow', 80, 50], ['Hideway', 50, 70], ['Freya', 80, 90]];
...
var totalSalesEcommerce = function totalSalesEcommerce() {
  ...
  var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  function getFormatter(params) {
    return params.map(function (_ref6) {
...
var userByLocationInit = function userByLocationInit() {
  ...
  if ($userByLocationMap) {
    ...
    echartSetOption(chart, userOptions, getDefaultOptions);
    var zoomLevel = 1;
    (_document$querySelect5 = document.querySelector('.user-by-location-map-zoom')) === null || _document$querySelect5 === void 0 ? void 0 : _document$querySelect5.addEventListener('click', function () {
      if (zoomLevel < maxZoomLevel) {
        zoomLevel += 1;
      }
      chart.setOption({
    ...
    (_document$querySelect6 = document.querySelector('.user-by-location-map-zoomOut')) === null || _document$querySelect6 === void 0 ? void 0 : _document$querySelect6.addEventListener('click', function () {
      if (zoomLevel > minZoomLevel) {
        zoomLevel -= 1;
      }
      chart.setOption({
...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  btnNoticeToggle && btnNoticeToggle.addEventListener(Events.CLICK, function (_ref7) {
...
var currentUser = function currentUser() {
  return {
    getCardManagementStatisticsCustomers: function getCardManagementStatisticsCustomers() {
      return 102228;
    },
    getCardManagementStatisticsOrders: function getCardManagementStatisticsOrders() {
      return 18374;
    },
    getCardActiveUsers: function getCardActiveUsers() {
      return [{
        name: 'Emma Watson',
        avatar: {
          img: 'team/1.jpg',
    ...
    getCardBestProducts: function getCardBestProducts() {
      return [{
        img: 12,
        title: 'TimeBank Pro',
        type: 'Landing',
...
var draggableInit = function draggableInit() {
  ...
  if (columnContainers.length) {
    ...
    sortable.on(Events.DRAG_STOP, function (_ref8) {
      var el = _ref8.data.source;
...
var renderCalendar = function renderCalendar(el, option) {
  ...
  calendar.render();
  (_document$querySelect7 = document.querySelector('.navbar-vertical-toggle')) === null || _document$querySelect7 === void 0 ? void 0 : _document$querySelect7.addEventListener('navbar.vertical.toggle', function () {
...
function initMap() {
  ...
  if ($googlemaps.length && window.google) {
    ...
    $googlemaps.forEach(function (itm) {
      ...
      themeController && themeController.addEventListener('clickControl', function (_ref9) {
...
var kanbanInit = function kanbanInit() {
  ...
  formHideButtons.forEach(function (button) {
    button.addEventListener(Events.CLICK, function (_ref11) {
      var el = _ref11.currentTarget;
  ...
  if (addListForm) {
    ...
    addListForm.addEventListener(Events.SHOW_BS_COLLAPSE, function (_ref12) {
      var el = _ref12.currentTarget;
      var nextElement = el.nextElementSibling;
      nextElement && nextElement.classList.add(ClassNames.D_NONE);
    });

    // Focus input field when the form is shown
    addListForm.addEventListener(Events.SHOWN_BS_COLLAPSE, function (_ref13) {
      var el = _ref13.currentTarget;
  ...
  collapseDismissButtons.forEach(function (button) {
    button.addEventListener(Events.CLICK, function (_ref14) {
      var el = _ref14.currentTarget;
...
var leafletActiveUserInit = function leafletActiveUserInit() {
  ...
  if (L && mapContainer) {
    ...
    themeController.addEventListener('clickControl', function (_ref15) {
      var _ref15$detail = _ref15.detail,
        control = _ref15$detail.control,
        value = _ref15$detail.value;
      if (control === 'theme') {
  ...
  if (navbar) {
    ...
    themeController.addEventListener('clickControl', function (_ref16) {
      var _ref16$detail = _ref16.detail,
        control = _ref16$detail.control,
        value = _ref16$detail.value;
      if (control === 'theme') {
...
var searchInit = function searchInit() {
  ...
  searchAreas.forEach(function (searchArea) {
    ...
    document.addEventListener(Events.CLICK, function (_ref17) {
...
var themeControl = function themeControl() {
  ...
  themeController.on('clickControl', function (_ref18) {
    var _ref18$detail = _ref18.detail,
      control = _ref18$detail.control,
      value = _ref18$detail.value;
    if (control === 'theme') {
...
var tinymceInit = function tinymceInit() {
  if (window.tinymce) {
    ...
    var themeController = document.body;
    themeController && themeController.addEventListener('clickControl', function (_ref19) {
